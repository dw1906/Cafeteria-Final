...
class NewAppNav extends React.Component{
    render(){
        return (
        ...
        <nav className="bt bb tc mw7 center mt4">
          <a className="f6 f5-l link bg-animate black-80 hover-bg-lightest-blue dib pa3 ph4-l" href="/c/home">Home</a>
          <a className="f6 f5-l link bg-animate black-80 hover-bg-light-green dib pa3 ph4-l" href="/c/Menu">Menu</a>
          <a className="f6 f5-l link bg-animate black-80 hover-bg-light-blue dib pa3 ph4-l" href="/c/CheckOut">Check-Out</a>
          <a className="f6 f5-l link bg-animate black-80 hover-bg-light-pink dib pa3 ph4-l" href="/home">LogOut</a>
        </nav>
      </header>
        )
    }
